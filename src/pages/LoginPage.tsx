...
export function LoginPage() {
  ...
  return (
    ...
    >
      <div className="pf-panel p-10 max-w-sm w-full text-center space-y-6">
        <div
          className="anim-spin mx-auto text-5xl select-none"
        ...
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--theme-text-muted)' }}>
            Gestione Schede Personaggio
          </p>
        </div>

        <button
          className="pf-btn pf-btn-gold w-full py-3 flex items-center justify-center gap-3 text-sm"
