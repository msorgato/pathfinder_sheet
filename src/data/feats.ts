...
export const FEATS: FeatDefinition[] = [
  ...
  { id: 'weapon_focus', name: 'Focalizzazione nell\'Arma', type: 'Combat', prerequisites: 'BAB +1', description: 'Sei particolarmente abile con un\'arma scelta.', benefit: '+1 ai tiri d\'attacco con l\'arma scelta.', repeatable: true },
  { id: 'weapon_specialization', name: 'Specializzazione nell\'Arma', type: 'Combat', prerequisites: 'Guerriero 4, Focalizzazione nell\'Arma', description: 'Sei specializzato nel causare danni con un\'arma.', benefit: '+2 ai tiri del danno con l\'arma scelta.', repeatable: true },
  ...
  { id: 'spell_focus', name: 'Focalizzazione Negli Incantesimi', type: 'General', description: 'Gli incantesimi di una scuola sono più difficili da resistere.', benefit: '+1 al CD degli incantesimi di una scuola scelta.', repeatable: true },
  { id: 'greater_spell_focus', name: 'Focalizzazione Negli Incantesimi Maggiore', type: 'General', prerequisites: 'Focalizzazione Negli Incantesimi', description: 'I tuoi incantesimi sono ancora più potenti.', benefit: '+2 al CD degli incantesimi della scuola scelta (cumulativo con Focalizzazione).', repeatable: true },
  ...
  { id: 'skill_focus', name: 'Focalizzazione dell\'Abilità', type: 'General', description: 'Hai una particolare affinità con una certa abilità.', benefit: '+3 alle prove di un\'abilità scelta. Se hai 10+ gradi, il bonus è +6.', repeatable: true },
